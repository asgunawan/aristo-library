# Swiss Bern Office Scene Note

Continues from `SWISS_ESCAPE_AND_BERN_SCENE_NOTE.md` (which ends at the corridor/sidearm beat and the escort indoors).

This is a rough scene-direction note for the Federal Palace office sequence, not locked prose.
...
## 1. Screening: the bag gets dumped first

The backpack never sits unopened in a federal office.

It is surrendered and inspected at the entrance, because that is bomb procedure.

The dump is the first confusion beat:

- out comes a rough gold bar, a single medieval coin, a padded case of crystals, three scuffed sports bottles, a phone, papers
...
The mystery is front-loaded as physical objects on a table, not a performance.

### The passport anomaly

When they run his documents, the machine coughs up two facts side by side:

- the passport is real, a U.S. citizen, an otherwise clean record
- but the travel history is nearly flat: a Japan holiday years ago, then nothing international, and no recorded entry into Switzerland at all

A valid passport, owned by a real person, showing a man standing inside a country he never legally entered.

Not proof of anything, but an irregularity that no procedure can file.

It is the first quiet flag, and it will matter again later when the missing-person query arrives.

## 2. Arrival in the room: false comfort

He is walked through, past staff who half-turn.

The escorting officer mutters to a colleague: "crank, but a good one."

The room is primed to treat this as the day's entertainment.

He is put in a small interview room, not a cell.

Containment by routine, not arrest.

Other officers drift to the doorway to watch. Not alarmed. Curious.
One leans on the frame like it is a smoke break.

This is the second false-comfort plateau.
They should be relaxed here, so the drop lands.

## 3. The downshift

The door closes and the tone changes.
...
He explains: who he is, where he is from, that he is here to seek recognition and protect his people, and that he needs diplomatic immunity.
...
### This correction is the spine of the scene.

Not because he made a small mistake.

Because the officer just realized the truth of him:

### real power, and no real protocol.

Undeniably real, and visibly lost.

That combination is what converts "impressive crank" into "I have to hand this upward."
...
The refusal is the officer reasserting that here, in this room, Earth's rules still rule.
...
He reaches into the already-opened, already-inspected bag on the table.
No negotiation. No telekinesis.
...
He presses a crystal from the padded case, and it splinters and goes dark.
Expended. Visibly dead.

Not vanished.

He leaves it on the table where it can be picked up later.
...
The officer who said no gets up and closes the window himself.
...
More magic indoors reopens the magician box.
The proof was already made in the corridor and sealed by one deep-read.

### 2. "Let me have my bag" negotiation
...
### The referral upward is covered in `SWISS_DIPLOMATIC_OPENING_NOTE.md`, which starts with the senior FSS officer calling up the chain.
