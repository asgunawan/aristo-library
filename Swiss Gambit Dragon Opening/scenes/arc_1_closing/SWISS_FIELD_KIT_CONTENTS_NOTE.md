...
No bag of holding, no bottomless pack, no personal portal-pocket.

The entire dramatic point of the field kit is that he cannot carry full war-gear invisibly.
What he brings is physically limited, visible, heavy, and awkward.

That awkwardness is the story.

## What He Does Not Bring

### The sword.

The sword lives in the kingdom, with his proper war-kit.

It cannot fit in an ordinary backpack, and it was not meant to.

The robe is the identity marker.
The sword is a later escalation (decked-out mode), not something he smuggles into a diplomacy scene.

## Final Field Kit Contents

### On him (worn, visible the entire scene)
...
The restriction is the character.

## Potion Rules

### Health potion: self-contained.

It carries its own charge and mends the body only.
It does nothing for mana.
...
It does not refill mana.
It makes his core absorb ambient mana faster.

That is a strong military asset in the mana-rich fantasy world.

On Earth it is effectively dead weight, because it multiplies an ambient field that is functionally zero.

### The rule both sit under:

### Nothing you drink creates mana. Mana comes only from mana-rich environments and rest.

The regen potion is useful precisely because of ambient mana, and useless without it.
That uselessness on Earth is itself proof of why Earth is the worst place for him.

## Ward: A Spell, Not An Item

A ward is not a gadget he carries.

It is a pre-cast defensive spell fixed onto a physical surface, that idles near-zero-cost and spends its stored charge all at once on trigger.

Two kinds apply:

### The robe is lightly warded (passive).
...
The object he always has on him, in both worlds, is the anchor.
...
### The ward and the crystals recharge only in a mana-rich environment.

Once spent on Earth, they stay spent until he returns to the kingdom and re-seeds them.

This keeps every resource finite and countable per Earth outing, which is what keeps him dangerous-but-constrained.

## Why The Kit Is Built This Way

The moment the bag is dumped for screening in Bern, the officers should see exactly this and no more.

They dump it and find:
- a rough gold bar and a single coin
- crystals they cannot identify (the glove, robe, and warded phone are already on him, not in the bag)
- a wallet, phones, papers
- three sports bottles
...
### the moment the fantasy gadgetry fails to appear, and there is just a tired young man with a gold bar, some stones, a glove, and a coin, is the moment he becomes serious to them.

Dangerous people do not usually travel this light.
