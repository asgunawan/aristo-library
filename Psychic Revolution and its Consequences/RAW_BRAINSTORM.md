# Psychic Revolution - Raw Brainstorm / Hold Bin

Use this file to collect uncategorized material, loose ends from the source document, and messy conceptual tangents that need to be evaluated before integrating them into the core lore files.

## Battle of Halfaya Pass (Detailed Scene Concepts)
- **Setting the Scene:** Alexandria planning room called the "Icebox" due to heavy American refrigeration units for the IBM 700-series punch card machines.
- **The Allied Squires:** The US Squires wait outside the planning rooms. They are NCOs acting as a Pit Crew. 2 guys for liquid-nitrogen tanking, 2 guys for lead-acid battery jump-starts, 6 guys with M1 Garands/Magnesium flares holding the line while the Ace powers up.
- **German Squires vs US Squires:** Great cultural contrast. Germans use Tier 2 psychics as disposable human armor ("Shields") to protect their valuable Tier 1 Knights. Americans use non-psychic humans (elite mechanics/infantry) to protect their standardized Ace. This means a fight with an American involves shooting through 10 trained humans + flares; a fight with a German involves fighting a phalanx of psychics that rapidly burns out.
- **The Fight Details:** Artie Gable gets tethered to the Sollum Radar Tower (borrowing 50 megawatts from the Alexandria grid) to act as a "Lighthouse," creating a 5-mile-wide Static Wall blocking Meyer's Snap. Meyer skims the Mediterranean waves at 200 mph to stay under the radar shadow of the cliffs, initiating a "Vertical Snap" to bypass the bulk of the wall. 
- **The Disconnect:** Because Artie is hooked into the Grid, his resolution is terrible and he can't pinpoint Meyer. He orders his crew to unplug him (dropping the Static Wall), and instead of a sophisticated TK needle flick, he brute-forces a 50lb Liquid Nitrogen Cannister at 150mph onto Meyer's barrier, atomizing Meyer's tubes with extreme cold and ending the battle. 
- **The Suez Fall:** The US command holds back Babe Didrikson and Jesse Owens for too long. With Artie recovering from "Neural Soot," Rommel's other aces (including Hanna Reitsch from the stratosphere and Von Cramm from miles away) quickly annihilate the last British Tier 1 (Derek "Echo" Harding) and steal 400 tons of Indian Mica. This could push the USSR to enter the war early.

## Rommel's Gazala Bunker (Scene Concept)
- Rommel, General Westphal, and Kurt Meyer planning the Halfaya assault. AEG cooling unit struggling. Vacuum tube shatters with a sharp *pop* as Meyer exits—the sound of the "Glass War" beginning.
- Meyer's Neural Jitter visible: gloved hands twitching, left eye tremoring every few seconds. Rommel: "Don't trigger a Thunderclap until you're over the target. If Gable hears you coming, the 'Machine' will be ready for the 'Knight.'"
- Westphal's warning: "The boy is fraying, Erwin. If we don't take the Suez in thirty days, Meyer won't be an Ace anymore. He'll be a Hollow." Rommel: "Then we have twenty-nine days to win."

## The Alexandria "Icebox" Confrontation (Scene Concept)
- Wavell's cold rage after the Suez falls. Slams hand on mahogany table. Confronts Masterson: "You sent me a baseball pitcher with a slide-rule. I needed a miracle, and you gave me a 'standardized' failure."
- Artie Gable stumbling in—flight suit stained, hands shaking with "Neural Hitch," admits: "Those Nazis are burning their souls like coal to win."
- Wavell demands Jesse Owens. Masterson lies: "Owens is... unproven." Wavell: "You're keeping him in a lead-lined basement in Alabama because you're afraid of the politics of a Black God saving the world."

## The FDR-Churchill "Neural-Link" Call (Scene Concept)
- Secret signal beamed across Atlantic. FDR in White House Map Room gripping telephone receiver vibrating with Jammer Static. Churchill in Cabinet War Rooms, cigar smoke and desperation.
- Churchill: "Without Indian Mica, my psychics are down to thirty minutes of flight time a day. London is a sitting duck."
- FDR's dilemma: Congress thinks psychics are "Vatican Superstition" or "New Deal Waste." Can't reveal Owens without losing the South and the election.

## The Brazil Negotiation (Scene Concept)
- Palácio Laranjeiras, Rio de Janeiro. Jasmine scent. "Static Pickets" humming.
- Vargas playing both sides: "The German ambassador offered me Philips blueprints and ten million Reichsmarks in gold."
- Babe Didrikson sensing Padilha's "Hum" from across the palace—her Crystal-Logic tubes glowing with sympathetic resonance.
- Masterson's Berger-Meter slamming into the red: "His conductivity rating is higher than Artie's. It's almost at the Owens level."

## The Capture of Fanny Blankers-Koen (Scene Concept)
- Meyer (Post-Refit, hands steady) "Whisper-Snaps" into her Amsterdam home at 3:00 AM.
- "Neural Leash" clamped on before she can process the threat. Children held hostage.
- The Philips Factory "Throne" being built—Indian Mica sheets installed. Scientist: "We aren't just building a machine. We are building a Throne."
- Meyer watching through observation glass: "If the machine fails to 'Anchor' her, she won't just walk out of this factory. She will walk through the air and take the Netherlands with her."

## The Soviet "Neural Scorched Earth" (Scene Concept)
- Stalin pacing in lead-lined Kremlin. Chart of Vacuum Tube Attrition on the table.
- Nina Dumbadze, eyes bloodshot: "If the Germans fix the Jitter, they will be able to 'Snipe' us from outside our Kinetic Scream."
- Stalin's order: NKVD sweeps through every orphanage from Moscow to the Urals. Any child with 0.00001% "Factor" seized for Integration Vats. Building a "Wall of Meat."

## The Japanese "Salt-Tank Hibernation" (Scene Concept)
- Tetsuo Iwasaki on the carrier Kaga, practicing "Water-Snapping" in total darkness.
- Psychics kept in near-death state in salt-water vats to preserve Neural Filaments.
- The "Blackout Snap" plan: destroy Pearl Harbor Integration Vaults, not battleships. If US psychics can't recalibrate, they "Soot" and die.

## The British "Echo-Chamber" (Scene Concept)
- Turing's desperate math: thousands of tiny tube arrays along English coast creating "Neural Illusions."
- When Meyer tries to Snap toward London, he "sees" 100 different targets. Risk of "Shunt" into the ocean.
- "If we cannot be the strongest, we shall be the most confusing."

## The Italian "Project Marconi" (Scene Concept)
- Hidden beneath Vatican or remote Tuscan villa. Brass, quartz, and gold wire machine that "sings" rather than "forces."
