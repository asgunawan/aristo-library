...
- **Strategic Position:** Controls 80% of the world's high-purity glass after capturing the Netherlands, allowing mass production of Gen-3 "Disposable" psychics as Panzer shields.
- **Vulnerability:** Cut off from Natural Mica, forcing the use of inferior synthetic "Fluor-Mica," which causes fatal "Neural Jitter" in their Aces. They rely on blockade runners and U-boats to smuggle what they can from Vichy Madagascar.
- **Atrocities:** "Heroes of Science" who fail the awakening process are wiped from existence. The SS conducts "Neural Salvage," surgically ripping tubes and mica out of dead psychics to reuse.

### United States of America
- **Program:** Project "Circuit-Breaker". Led by Artie Gable and Mildred "Babe" Didrikson.
- **Strategic Position:** High-budget, safe, standardized assembly lines using IBM logic and Westinghouse soft-fuses. Psychics fight like heavily supported Tanks.
- **Vulnerability:** They lack the pure Dutch glass, meaning American Aces suffer from "foggy" resolution when Snapping. They are completely dependent on importing Mica to insulate their massive awakening machines (Integration Vaults).
- **Secrets:** Harboring Jesse Owens, a natural Tier 0 (Super-Conductor) in Alabama, hidden due to racial politics but maintained as a final, absolute deterrent.

### Great Britain & The UK
- **Program:** Project "Arthur" based at Bletchley Park. Led (formerly) by Jack Lovelock and Sydney Wooderson.
- **Strategic Position:** Mastered the "Slow-Cook" resonance method over 30 days. Their psychics are mathematically precise, stealthy "Ghosts" who sync with Chain Home Radar to see the battlefield beyond visual limits.
- **Vulnerability:** The Suez Canal. If Rommel cuts off the natural Mica pipeline from British India, the British psychic program will instantly flatline.

### USSR (Soviet Union)
- **Program:** The "Red Resonators". Led by Nina Dumbadze.
- **Strategic Position:** Utter dependence on brute force and "Dirty Power" from the Svetlana Tube Plant. They pump unfiltered energy to yield raw, devastating kinetic force with no concern for safety. 
- **Vulnerability:** The psychics are tethered to "Integration Trains" and must stay near the front lines; moving away for 72 hours leads to madness or death. 
...
- **Strategic Position:** Zen-integration allowing them to produce Aero-Shinobis equipped with non-magnetic obsidian shards payload, rendering them invisible to radar and magnetic sensors. 
- **Vulnerability:** Reliant on securing Mica from the Indonesian/Indian archipelago and trading with Germany (Mica for Tube Math). Extreme resource starvation leads to desperate strikes (Pearl Harbor "Blackout Snap").
