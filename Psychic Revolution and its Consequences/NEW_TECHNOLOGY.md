...
- **Psi-Rations & Smes-7:** High-density, chemical sludge and energy bars engineered to provide 10,000-plus calories a day, utilizing dense animal fats, glucose, and amphetamines. Prevents the psychic from metabolizing their own muscles.

## Anti-Psychic Countermeasures
Standard weapons are practically useless against a prepared Ace, accelerating the invention of purpose-built counter-tech.

- **Static Jammers:** The ultimate area-denial weapon. Massive broadcasting towers that pump out "Neural Noise." Within 10-20 miles of an active Jammer, a psychic's brain cannot focus enough to execute a Ramp-Up or a Snap. They make major cities entirely "Neural-Black" (unflyable/untargetable). 
- **The Störsender (Jammer) V-2 Rocket:** An offensive application of the Static Jammer. Instead of explosives, von Braun’s rockets deploy cobalt magnets and vacuum tubes to create a 10-minute "Super-Static Field" upon impact, paralyzing interceptors through massive migraines while allowing German Aces a brief window for assassination strikes.
- **Project "White Noise" (The Neural Bomb):** An alternative to the Manhattan Project. Oppenheimer and Fermi use Polonium or unstable Cobalt to create a localized Electro-Psychic Pulse (EPP). It creates a "Psychic Vacuum" for 50 miles, permanently blowing out all vacuum tubes and turning any psychic within the blast radius into a lobotomized Hollow.
- **Magnesium "Flicker" Flares:** Since spatial Snapping requires direct line-of-sight to prevent a "Shunt," mundane infantry utilize aggressively blinding magnesium flares to ruin an attacking psychic's vision, saving squads by preventing teleportation.
- **Anti-Tank Rifles for Infantry:** .30-06 and standard rifles bounce off a kinetic barrier. Normal infantry are thus issued massive Anti-Tank rifles strictly meant to deliver enough raw kinetic energy into a barrier to shatter it and kill the hovering psychic.
- **Internal Tank Bolts:** An unshielded tank crew is incredibly vulnerable—a psychic can simply use telekinesis to crush or rip apart the crew inside the metal shell. Tanks are specifically reinforced with internal dampening bolts and shielding layers to "Psychic-Proof" the armor.
